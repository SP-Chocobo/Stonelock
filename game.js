...
const CHARMS = {
  ...
  ironpouch:    { label: 'Iron Pouch',        blurb: 'Your stones ignore exhaustion, and your maximum Standing is +2.', noExhaust: 1, maxStandingAdd: 2 },
  hardened:     { label: 'Hardened',          blurb: 'Your maximum Standing is +3.', maxStandingAdd: 3 },
  fieldsurgeon: { label: 'Field Surgeon',     blurb: 'Clearing a table heals +4 Standing.', healBonus: 4 },
  ...
  vigor:        { label: 'Vigor',             blurb: 'Start each table at full Standing, and your maximum Standing is +2.', maxStandingAdd: 2, on: { fightStart: g => { g.standing = g.maxStanding; } } },
