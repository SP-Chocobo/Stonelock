...
const CHARMS = {
  ...
  momentum:     { label: 'Momentum',          blurb: 'When you win a hand, your board reads +1 higher next hand — up to +3, and a loss resets it.', on: { handWon: g => { g.winStreak = (g.winStreak || 0) + 1; }, handLost: g => { g.winStreak = 0; }, handStart: g => { if (g.winStreak) g.handBuff = (g.handBuff || 0) + Math.min(3, g.winStreak); } } },
